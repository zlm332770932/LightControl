...
public abstract class FileSystem {
    ...
    public static File getSettingPath() {
        ...
        return new File(root.getAbsolutePath() + File.separator + "LightControl");
    }
